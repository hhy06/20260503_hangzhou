"""Generate plant_topology.py for scenario srw_hangzhou1.
...
Outputs:
    scenario/srw_hangzhou1/plant_topology.py  (Python with NODES + EDGES dicts)
...
def generate(lines: dict[str, dict], simple_bom: dict[str, dict[str, float]],
    ...
    out = []
    out.append('"""Plant topology for srw_hangzhou1 (auto-generated).')
    out.append("")
