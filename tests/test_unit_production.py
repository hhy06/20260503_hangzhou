...
class TestProductionQueueOrder:
    def test_sort_by_start_time_then_job_id(self):
        ...
        prod.add_production_order(ProductionOrder(order_id=3, sku="A", quantity=10, activate_time=10, expect_time=100, node_name="X"))
        prod.add_production_order(ProductionOrder(order_id=1, sku="A", quantity=10, activate_time=5, expect_time=100, node_name="X"))
        prod.add_production_order(ProductionOrder(order_id=2, sku="A", quantity=10, activate_time=10, expect_time=100, node_name="X"))
        # Expected order: (5,1), (10,2), (10,3)
        assert [j.order_id for j in prod.production_queue] == [1, 2, 3]

    def test_same_start_time_lower_job_id_first(self):
        _, _, prod, _ = _make_production_scene()
        prod.add_production_order(ProductionOrder(order_id=5, sku="A", quantity=10, activate_time=5, expect_time=100, node_name="X"))
        prod.add_production_order(ProductionOrder(order_id=3, sku="A", quantity=10, activate_time=5, expect_time=100, node_name="X"))
        prod.add_production_order(ProductionOrder(order_id=4, sku="A", quantity=10, activate_time=5, expect_time=100, node_name="X"))
        assert prod.production_queue[0].order_id == 3
        assert prod.production_queue[1].order_id == 4
        assert prod.production_queue[2].order_id == 5
...
class TestOutputToDownstream:
    def test_successful_output(self):
        ...
        job = ProductionOrder(sku="SKU_A", quantity=100, activate_time=0, expect_time=100, node_name="TestProd")
        prod._output_to_downstream("SKU_A", 100, job)
    ...
    def test_output_accepted_even_when_full(self):
        ...
        job = ProductionOrder(sku="SKU_A", quantity=50, activate_time=0, expect_time=100, node_name="TestProd")
        prod._output_to_downstream("SKU_A", 50, job)
...
class TestExecuteJob:
    def test_production_fails_on_insufficient_material(self):
        ...
        job = ProductionOrder(order_id=1, sku="SKU_A", quantity=100, activate_time=0, expect_time=500, node_name="TestProd")
    ...
    def test_job_not_started_before_start_time(self):
        ...
        job = ProductionOrder(order_id=1, sku="SKU_A", quantity=100, activate_time=50, expect_time=500, node_name="TestProd")
        prod.add_production_order(job)
    ...
    def test_production_batch_timing(self):
        ...
        job = ProductionOrder(order_id=1, sku="SKU_A", quantity=250, activate_time=0, expect_time=500, node_name="TestProd")
        prod.add_production_order(job)
    ...
    def test_two_jobs_sequential(self):
        ...
        prod.add_production_order(
            ProductionOrder(order_id=1, sku="SKU_A", quantity=250, activate_time=0, expect_time=500, node_name="TestProd"))
        prod.add_production_order(
            ProductionOrder(order_id=2, sku="SKU_A", quantity=100, activate_time=50, expect_time=500, node_name="TestProd"))
